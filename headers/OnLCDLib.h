...
#define LCD_DATA_START_PIN	3		// In 8-bit mode pins 0-7 will be used, in 4-bit mode 0-3 if 0 is first
#define LCD_RS_CONTROL_DDR 	DDRB 	//									 |
#define LCD_RW_CONTROL_DDR 	DDRB 	//									 |
#define LCD_E_CONTROL_DDR 	DDRB 	//									 |
#define LCD_RS_CONTROL_PORT PORTB 	// Port where RS, RW, E pins are	 |
#define LCD_RW_CONTROL_PORT PORTB 	// Port where RS, RW, E pins are	 |
#define LCD_E_CONTROL_PORT 	PORTB 	// Port where RS, RW, E pins are	 |
#define LCD_RS_PIN			PB0 	// Register selection signal		 |
#define LCD_RW_PIN			PB1 	// Read/write signal 				 |
#define LCD_E_PIN 			PB2 	// Enable signal					 |
//																		 |
// LCD type																 |
